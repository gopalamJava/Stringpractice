...
public class APIResponseParser {
	...
	public static Book parse(String response) {
		...
		book.setRatingsCount(Double.valueOf(ratingsCount).intValue());
	...
	private static String parse(String response, String startRule, String endRule) {
		...
		startIndex = startIndex + startRule.length();
		int endIndex = response.indexOf(endRule, startIndex);
		String resultString = response.substring(startIndex, endIndex);
		return resultString;
	}
